...
interface Social {              // on a Resource, Review or Comment, for one user
    ...
    clicks?:        Date[]      // timestamps of all clicks from that user on the resource link  [only for a resource, not a Review of Comment]
}
...
interface ResourceIndex {
    ...
    // Clicks statistics
    clicks:         number,     // count of all users clicks
    dayclicks:      number,     // count of all users clicks in the last 24 hours
    weekclicks:     number,     // count of all users clicks in the last 7 days
    monthclicks:    number      // count of all users clicks in the last 30 days
}
